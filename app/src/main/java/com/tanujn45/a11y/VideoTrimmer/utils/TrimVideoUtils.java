package com.tanujn45.a11y.VideoTrimmer.utils;
...
import com.tanujn45.a11y.VideoTrimmer.fix.MovieCreator;
...
public class TrimVideoUtils {
    ...
    private static void genVideoUsingMp4Parser(@NonNull File src, @NonNull File dst, long startMs, long endMs, @NonNull OnTrimVideoListener callback) throws Exception {
        ...
        fc.close();
        fos.close();
        if (callback != null) callback.getResult(Uri.parse(dst.toString()), (int) startMs, (int) endMs);
    }
